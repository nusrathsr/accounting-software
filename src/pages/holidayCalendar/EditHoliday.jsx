...
//   const { id } = useParams(); // holiday id from URL
...
//       navigate("/holidays"); // redirect back to holiday list
//     } catch (err) {
//       Swal.fire({
//         icon: "error",
//         title: "Error",
//         text: "Failed to update holiday. Please try again.",
//       });
//     }
//   };
  ...
  useEffect(() => {
    const fetchHoliday = async () => {
      try {
        ...
        Swal.fire({
          title: "Error!",
          text: "Failed to load holiday details.",
          icon: "error",
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="flex items-center gap-3">
            ...
            <p className="text-lg text-gray-700">Loading holiday details...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 mb-8 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 px-8 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Edit Holiday</h1>
                <p className="text-blue-100 text-sm">Modify existing holiday record</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800">
              <p className="font-medium mb-1">Edit Holiday Tips:</p>
              <ul className="list-disc list-inside space-y-1 text-blue-700">
                <li>Holiday name changes will be reflected across all employee calendars</li>
                <li>Date modifications may affect existing leave calculations</li>
                <li>Updated descriptions help employees understand holiday significance</li>
                <li>All changes are saved permanently once submitted</li>
                <li>Consider notifying employees of any significant holiday changes</li>
              </ul>
            </div>
          </div>
        </div>
