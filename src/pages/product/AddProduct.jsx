          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-700">
                ...
                <li>Product ID is automatically generated and cannot be modified</li>
                <li>Tax settings are optional but recommended for accurate pricing</li>
                <li>Multiple sizes can be added for inventory tracking</li>
              </ul>
            </div>
          </div>
        </div>
